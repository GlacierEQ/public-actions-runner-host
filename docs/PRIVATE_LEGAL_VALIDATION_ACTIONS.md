...
The workload-isolation and immutable-source controls from public-runner PR #80 and the Operator Code validator from PR #84 are merged into `main`. These legal actions extend that same security boundary without replacing it.
